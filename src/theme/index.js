...
import { colorPalettes, getColorScheme } from "./colors";
import { getComponentOverrides } from "./components";
import { getTypography } from "./typography";

// Create theme function with enhanced features
export const createAppTheme = (mode = "dark", color = "orange") => {
  ...
  const components = getComponentOverrides(mode, primaryColor);
...
// Export utilities
export { colorPalettes, getColorScheme } from "./colors";
export { getComponentOverrides } from "./components";
